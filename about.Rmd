...
## About the blog
I'd love to say that this blog is going to be something that deals with bleeding-edge research that happens in the field of Statistics/Mathematics, but then I'd be lying. The Symphony of Statistics is a blog run by myself an amateur in the vast field that is Statistics. As of now, it wouldn't be featuring Statistics that is too difficult for a high schooler to grasp.

I will be posting regularly (every 3 days or so) about the interesting things that Statistics have to offer, and my experiences in taking the specialization by Duke University. The intended audience of this blog are statisticians, learners, and heck, anyone with the remotest interest in Statistics! This blog doesn't intend to be a comprehensive guide to statistics, but rather strives to be a source of informally presented explanations in various areas of Statistics.
